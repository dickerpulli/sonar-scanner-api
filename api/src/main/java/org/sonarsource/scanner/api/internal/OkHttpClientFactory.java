...
public class OkHttpClientFactory {
	...
	static OkHttpClient create(Logger logger) {
		...
		if (!System.getProperty("http.basicAuthUser", "").isEmpty()) {
			String credential = Credentials.basic(System.getProperty("http.basicAuthUser"),
					System.getProperty("http.basicAuthPassword"));
	...
	private static KeyStore initKeyStore(Logger logger, final String defaultKeyStore, String defaultKeyStoreType,
			String defaultKeyStoreProvider, char[] passwd) throws KeyStoreException, NoSuchProviderException,
